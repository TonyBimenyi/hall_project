...
SECRET_KEY = 'django-insecure-1n@x%q^nl73*ywg879wh2!x!uvmn2wpt)3(c-1iit46!l(=c&p'
...
USE_MYSQL = os.environ.get('DJANGO_USE_MYSQL', '0') == '1'
...
# FRONTEND_URL = os.environ.get('FRONTEND_URL', 'https://menyesha-hubi.vercel.app')

DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'webmaster@localhost')
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_PORT = 587
EMAIL_HOST_USER = 'tonyblaisb@gmail.com'
EMAIL_HOST_PASSWORD = 'arypjixampqjrvwf'
EMAIL_USE_TLS = True
